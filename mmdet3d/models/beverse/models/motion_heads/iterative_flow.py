...
class IterativeFlow(BaseMotionHead):
    ...
    def forward(self, bevfeats, targets=None, noise=None, **kwargs):
        '''
        ...
        # targets: dict_keys(['gt_bboxes_3d', 'gt_labels_3d', 'gt_bboxes_ignore', 'semantic_seg', 'semantic_map', 'motion_segmentation', 'motion_instance', 'instance_centerness', 'instance_offset', 'instance_flow', 'future_egomotion', 'aug_transform', 'img_is_valid'])
        # bevfeats = bevfeats[0]
        ...
        # import ipdb
        # ipdb.set_trace()
        # vis_bev_feature(res['segmentation'][0].detach(), 'motion_seg')
