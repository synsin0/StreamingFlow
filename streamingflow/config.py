...
_C.DATASET.USE_MULTISWEEP = False
_C.DATASET.FRAME_SKIP = 4
...
_C.LIFT.RANGE = [-50, -50, -5.0, 50, 50, 3.0]
...
_C.MODEL.USE_GRU_ODE = False
_C.MODEL.USE_HYBRID_ODE = False

_C.MODEL.SOLVER = 'euler'
_C.MODEL.IMPUTE = False
_C.MODEL.STEP_DELTA_T = 0.05

_C.MODEL.MODALITY = CN()
_C.MODEL.MODALITY.USE_LIDAR = True
_C.MODEL.MODALITY.USE_RADAR = False
_C.MODEL.MODALITY.USE_CAMERA = False

_C.MODEL.LIDAR = CN()
_C.MODEL.LIDAR.USE_STPN = False
_C.MODEL.LIDAR.USE_BESTI = False
_C.MODEL.LIDAR.USE_RANGE = False
_C.MODEL.LIDAR.USE_ALL_POINTS = False

_C.MODEL.SMALL_ENCODER = CN()
_C.MODEL.SMALL_ENCODER.FILTER_SIZE = 64
_C.MODEL.SMALL_ENCODER.SKIPCO = False



_C.VOXEL = CN()  # Lidar pointcloud voxelization
_C.VOXEL.VOXEL_SIZE = (0.5, 0.5, 0.4)
_C.VOXEL.AREA_EXTENTS = [[-50., 50.], [-50., 50.], [-3, 2]]
...
_C.MODEL.DISTRIBUTION.LATENT_DIM = 64
...
_C.MODEL.FUTURE_PRED.DELTA_T = 0.05
_C.MODEL.FUTURE_PRED.USE_VARIABLE_ODE_STEP = False
